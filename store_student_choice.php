...
// 准备SQL语句
$stmt = $conn->prepare("INSERT INTO S_CHOICE_T(SNO, SNAME, FRIST_TNO, SECOND_TNO, THIRD_TNO) VALUES (?, ?, ?, ?, ?)");

// 绑定参数
$stmt->bind_param("ssiii", $sno, $sname, $first_tno, $second_tno, $third_tno);
